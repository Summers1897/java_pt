package util.db.mysql.exportDB;
...
public class mysqlImportandExport {
	...
	private static String getExportCommand(Properties properties) {
		...
		// 注意哪些地方要空格，哪些不要空格
		command.append("C:\\Program Files\\MySQL\\MySQL Server 5.5\\bin\\mysqldump -u").append(username).append(" -p").append(password)// 密码是用的小p，而端口是用的大P。
