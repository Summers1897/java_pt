package com.k.webshop.action.base;

import java.util.ArrayList;
import java.util.List;

import com.k.webshop.util.page.Page;
import com.k.webshop.util.page.PageActionDispatcher;
import com.k.webshop.util.page.PageComponentBean;
...
public class PaginationAction extends BaseAction {
	...
	public Page getListPage(List list, Page page) throws Exception {
	...
	public String outPutNavBar(int cols, String firstPMethod,
		...
		navBar.append("<tr class='linePage' id='exceptLine' height='25' algin=\"left\">");
		...
		if ((firstPage && lastPage) || pages == 0) {// 只有一页或者没有数据的情况
			...
			navBar.append("<input id='" + gotoPageButton.getId()
					+ "' type=text maxlength=10 style='height:20px;width:40px;border:1px solid #c8cece' value='");
			navBar.append(index);
			navBar.append("'>");
			...
			navBar.append("<input id='" + gotoPageButton.getId()
					+ "' type=text style='height:20px;width:40px;border:1px solid #c8cece' maxlength=10 value='");
			navBar.append(index);
			navBar.append("'><input type=button style='height:20px;margin-left:3px;width:30px;border:1px solid #c8cece' value='转' onclick='"	+ gotoMethod + "'>");
			...
			navBar.append("<input id='" + gotoPageButton.getId()
					+ "' type=text style='height:20px;width:40px;border:1px solid #c8cece' maxlength=10 value='");
			navBar.append(index);
			navBar.append("'><input type=button style='height:20px;margin-left:3px;width:30px;border:1px solid #c8cece' value='转' onclick='"
					+ gotoMethod + "'>");
		}
		navBar.append("&nbsp;&nbsp;&nbsp;每页显示");
		navBar.append("<input type='text' maxlength=10 style='height:20px;width:40px;border:1px solid #c8cece' name='page.maxNo' value='"+page.getMaxNo()+"'>条");
		navBar.append("<input type='button' style='height:20px;margin-left:3px;width:40px;border:1px solid #c8cece' value='确定' onclick='"+gotoMethod+"'>");
		navBar.append("</td></tr>");
