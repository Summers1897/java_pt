...
<html>
  <head>
	...
	<script language="JavaScript" src="<%=basePath%>common/js/date/WdatePicker.js"  defer="defer"></script>
	<script language="JavaScript" src="<%=basePath%>common/js/util.js"  defer="defer"></script>
	        ...
	        <tr>
	          <td align="left" style="height:30px; border-color:#b6c6cd; border-style:solid; border-width:1px 1px 0px 1px;padding:3px 0px 1px 3px" bgcolor="#d5e9f9"><div style="float:left">
               ...
               <div style="text-align:right;padding-right:3px">
				店铺名称： <input type="text" class="searchbox" id="shopName" name="shopName" value="${shopName}"     >
	  ...
	  <table width="100%" border="0" cellpadding="0" cellspacing="1" class="tab01">
	    ...
	    <thead>
			<tr  >
				...
				<th width="10%" style="text-align: center;" >店铺名称</th>
