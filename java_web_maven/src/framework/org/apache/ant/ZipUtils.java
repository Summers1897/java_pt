...
public class ZipUtils {
	 ...
	 * @throws Exception ant下的zip工具默认压缩编码为UTF-8编码， 而winRAR软件压缩是用的windows默认的GBK或者GB2312编码 用ant压缩后放到windows上面会出现中文文件名乱码，用winRAR压缩的文件，用ant解压也会出现乱码， 所以，在用ant处理winRAR压缩的文件时，要设置压缩编码
	 */
